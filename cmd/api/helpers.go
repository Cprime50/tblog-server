...
// Handlers to avoid rewriting same code over again
// Read json
...
func (app *application) writeJSON(w http.ResponseWriter, status int, data interface{}, headers ...http.Header) error {
	...
	// if in developement cleaner json else normal marrshal
...
func (app *application) errorJSON(w http.ResponseWriter, err error, status ...int) {
	...
	//Custom error
	// Here we are writing custom errors to be displayed in place of common sql errors we might get
	// since sql errors are not very descriptive
	var customErr error
